...
* [samyama-ai/samyama-graph](https://github.com/samyama-ai/samyama-graph) - A graph-vector database combining property-graph traversal (~90% openCypher) with HNSW vector search in a single engine
